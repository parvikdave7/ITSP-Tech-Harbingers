# USAGE
# python full_pipeline2.py --encodings encodings.pickle --model liveness.model --recognizer output/recognizer.pickle --le output/le.pickle --le_liveness le_liveness.pickle
# python full_pipeline2.py --encodings encodings.pickle --output output/jurassic_park_trailer_output.avi --display 0 --le-liveness le_liveness.pickle
